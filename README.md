...
- **Styling**: 
  ...
  - [Chakra UI](https://chakra-ui.com/) 3.28.1
...
- **Charts**: [Recharts](https://recharts.org/) 3.5.1
- **Animation**: [Framer Motion](https://www.framer.com/motion/) 12.23.24
- **PDF Generation**: [jsPDF](https://github.com/parallax/jsPDF) 4.0.0

### Backend
- **Framework**: [FastAPI](https://fastapi.tiangolo.com/) 0.104.0+
...
- **File Uploads**: [python-multipart](https://github.com/andrew-d/python-multipart)
